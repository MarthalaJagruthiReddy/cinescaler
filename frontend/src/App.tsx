...
export default function App() {
  ...
  return <main className="app"><header><div className="logo"><span className="logo-icon">◉</span><span>Cine<span>Scaler</span></span></div><div className="header-right"><span className="live"><i /> model stream live</span><span className="mono">QoE / 0.1</span></div></header>
